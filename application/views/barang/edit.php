            ...
            <form action="<?= base_url('edit-barang/'.$b['id_barang']); ?>" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="harga_jual_reseller_cash" class="form-control" value="<?= set_value('harga_jual_reseller_cash', $b['harga_jual_reseller_cash']); ?>" required="">
                  <?= form_error('harga_jual_reseller_cash', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Harga Jual (Reseller Tempo)</label>
                  <input type="number" name="harga_jual_reseller_tempo" class="form-control" value="<?= set_value('harga_jual_reseller_tempo', $b['harga_jual_reseller_tempo']); ?>" required="">
