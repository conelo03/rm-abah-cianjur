          ...
          <div class="card">
            <form action="<?= base_url('tambah-barang-keluar'); ?>" method="post">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-4 form-group">
                    <div class="form-group">
                      ...
                      <input type="text" name="id_penjualan" class="form-control" value="<?= set_value('id_penjualan', $id_penjualan); ?>" readonly="">
                      <?= form_error('id_penjualan', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                  </div>
                  <div class="col-lg-4 form-group">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <a style="color: white;" class="btn btn-info" onclick="tambahItem()"><i class="fa fa-plus"></i> Tambah Item</a>
                    <a style="color: white;" class="btn btn-danger" onclick="hapusItem()"><i class="fa fa-trash"></i> Reset Item</a>
                  </div>
                </div>
                <div class="row">
